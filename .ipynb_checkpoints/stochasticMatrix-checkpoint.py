...
def calculate_transition_probabilities():
    ...
    for x in range(max_state):
        for y in range(max_state):
            ...
            # 更新转移矩阵
            transition_matrix[current_state_index, next_state_index_no_prize] = prob_no_prize
            transition_matrix[current_state_index, next_state_index_first_prize] = prob_first_prize
            transition_matrix[current_state_index, next_state_index_second_prize] = prob_second_prize
